---
title: 'Extending the frequency estimator to any quantile'
description: 'A frequentist ping-pong estimator extended to any quantile'
pubDate: 2025-07-18
...
Anything that can be used as a reference for what the distribution used to look like.